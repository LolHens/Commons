...
import cassandravis.swing.renderer.ExceptionRenderer;
...
public class JCanvas extends JComponent {
    ...
    private cassandravis.swing.renderer.Renderer renderer;
    private int lastWidth, lastHeight;

    public JCanvas() {
    }

    public JCanvas draw(cassandravis.swing.renderer.Renderer renderer) {
