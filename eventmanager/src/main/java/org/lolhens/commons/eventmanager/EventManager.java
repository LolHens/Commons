...
import org.lolhens.commons.filterlist.Blacklist;
import org.lolhens.commons.filterlist.Filterlist;
import org.lolhens.commons.reflect.ReflectionUtil;
...
public class EventManager {
    ...
    public final void registerEventListener(Object eventListener, Filterlist<EventType> filterlist) {
        ...
        targets.addAll(ReflectionUtil.getAnnotatedConstructors(eventListenerClass,
                asList(EventListener.class, EventListener.Group.class), null));
